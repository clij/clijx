...
class CLIJ2AutoComplete {
   ...
   public static ArrayList<BasicCompletion> getCompletions(final ScriptingAutoCompleteProvider provider) {
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.minimumXProjection(ClearCLImageInterface source, ClearCLImageInterface destination_sum)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clij2.minimumYProjection(ClearCLImageInterface source, ClearCLImageInterface destination_sum)";
