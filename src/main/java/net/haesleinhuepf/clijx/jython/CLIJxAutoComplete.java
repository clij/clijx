...
class CLIJxAutoComplete {
   ...
   public static ArrayList<BasicCompletion> getCompletions(final ScriptingAutoCompleteProvider provider) {
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.applyWekaModel(ClearCLBuffer arg1, ClearCLBuffer arg2, CLIJxWeka2 arg3)";
       description = "<b>applyWekaModel</b><br><br>Applies a Weka model using functionality of Fijis Trainable Weka Segmentation plugin. <br><br>It takes a 3D feature stack (e.g. first plane original image, second plane blurred, third plane edge image)and applies a pre-trained a Weka model. Take care that the feature stack has been generated in the sameway as for training the model!<br><br>Parameters:<br>ClearCLBuffer arg1, ClearCLBuffer arg2, CLIJxWeka2 arg3";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.detectMaximaSliceBySliceBox(ClearCLBuffer arg1, ClearCLBuffer arg2, Integer arg3, Integer arg4)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.detectMinimaSliceBySliceBox(ClearCLBuffer arg1, ClearCLBuffer arg2, Integer arg3, Integer arg4)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.drawBox(ClearCLImageInterface arg1, Float arg2, Float arg3, Float arg4, Float arg5)";
       description = "<b>drawBox</b><br><br>Draws a box at a given start point with given size. <br>All pixels other than in the box are untouched. Consider using `set(buffer, 0);` in advance.<br><br>Parameters:<br>ClearCLImageInterface arg1, Float arg2, Float arg3, Float arg4, Float arg5";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.drawLine(ClearCLImageInterface arg1, Float arg2, Float arg3, Float arg4, Float arg5, Float arg6, Float arg7, Float arg8)";
       description = "<b>drawLine</b><br><br>Draws a line between two points with a given thickness. <br><br>All pixels other than on the line are untouched. Consider using `set(buffer, 0);` in advance.<br><br>Parameters:<br>ClearCLImageInterface arg1, Float arg2, Float arg3, Float arg4, Float arg5, Float arg6, Float arg7, Float arg8";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.drawSphere(ClearCLImageInterface arg1, Float arg2, Float arg3, Float arg4, Float arg5)";
       description = "<b>drawSphere</b><br><br>Draws a sphere around a given point with given radii in x, y and z (if 3D). <br><br> All pixels other than in the sphere are untouched. Consider using `set(buffer, 0);` in advance.<br><br>Parameters:<br>ClearCLImageInterface arg1, Float arg2, Float arg3, Float arg4, Float arg5";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       description = "<b>maximumZProjectionBounded</b><br><br>Determines the maximum projection of an image along Z within a given z range.<br><br>Parameters:<br>ClearCLImageInterface source, ClearCLImageInterface destination_max, Integer min_z, Integer max_z";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       description = "<b>meanBox</b><br><br>Computes the local mean average of a pixels rectangular neighborhood. The rectangles size is specified by <br>its half-width and half-height (radius).<br><br>Parameters:<br>ClearCLImageInterface arg1, ClearCLImageInterface arg2, Integer arg3, Integer arg4, Integer arg5";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.meanClosestSpotDistance(ClearCLBuffer arg1, ClearCLBuffer arg2)";
       description = "<b>meanClosestSpotDistance</b><br><br>Determines the distance between pairs of closest spots in two binary images. <br><br>Takes two binary images A and B with marked spots and determines for each spot in image A the closest spot in image B. Afterwards, it saves the average shortest distances from image A to image B as 'mean_closest_spot_distance_A_B' and from image B to image A as 'mean_closest_spot_distance_B_A' to the results table. The distance between B and A is only determined if the `bidirectional` checkbox is checked.<br><br>Parameters:<br>ClearCLBuffer arg1, ClearCLBuffer arg2";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       description = "<b>meanZProjectionBounded</b><br><br>Determines the mean projection of an image along Z within a given z range.<br><br>Parameters:<br>ClearCLImageInterface source, ClearCLImageInterface destination_mean, Integer min_z, Integer max_z";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       description = "<b>nonzeroMaximumDiamond</b><br><br>Apply a maximum filter (diamond shape) to the input image. <br><br>The radius is fixed to 1 and pixels with value 0 are ignored.<br><br>Parameters:<br>ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.nonzeroMinimumBox(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3)";
       description = "<b>nonzeroMinimumBox</b><br><br>Apply a minimum filter (box shape) to the input image. <br><br>The radius is fixed to 1 and pixels with value 0 are ignored.<br><br>Parameters:<br>ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.nonzeroMinimumDiamond(ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3)";
       description = "<b>nonzeroMinimumDiamond</b><br><br>Apply a minimum filter (diamond shape) to the input image. <br><br>The radius is fixed to 1 and pixels with value 0 are ignored.<br><br>Parameters:<br>ClearCLImageInterface arg1, ClearCLImageInterface arg2, ClearCLImageInterface arg3";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.pullLabelsToROIList(ClearCLBuffer arg1, List arg2)";
       description = "<b>pullLabelsToROIList</b><br><br>Pulls all labels in a label map as ROIs to a list. <br><br>From ImageJ macro this list is written to the log <br>window. From ImageJ macro conside using pullLabelsToROIManager.<br><br>Parameters:<br>ClearCLBuffer arg1, List arg2";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       description = "<b>scale</b><br><br>DEPRECATED: CLIJ scale() is <b>deprecated</b>. Use scale2D or scale3D instead!<br><br>Parameters:<br>ClearCLBuffer arg1, ClearCLBuffer arg2, Float arg3";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.setRandom(ClearCLBuffer arg1, Float arg2, Float arg3)";
       description = "<b>setRandom</b><br><br>Fills an image or image stack with uniformly distributed random numbers between given minimum and maximum values. <br><br>Recommendation: For the seed, use getTime().<br><br>Parameters:<br>ClearCLBuffer arg1, Float arg2, Float arg3";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       description = "<b>setWhereXequalsY</b><br><br>Sets all pixel values a of a given image A to a constant value v in case its coordinates x == y. <br><br>Otherwise the pixel is not overwritten.<br>If you want to initialize an identity transfrom matrix, set all pixels to 0 first.<br><br><pre>f(a) = v</pre><br><br>Parameters:<br>ClearCLImageInterface source, Float value";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       description = "<b>skeletonize</b><br><br>Erodes a binary image until just its skeleton is left. <br><br>The result is similar to Skeletonize3D in Fiji.<br><br>Parameters:<br>ClearCLBuffer source, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.tenengradFusion(ClearCLBuffer arg1, float[] arg2, float arg3, ClearCLBuffer[] arg4)";
       description = "<b>tenengradFusion</b><br><br>Fuses #n# image stacks using Tenengrads algorithm.<br><br>Parameters:<br>ClearCLBuffer arg1, float[] arg2, float arg3, ClearCLBuffer[] arg4";
       list.add(new BasicCompletion(provider, headline, null, description));
