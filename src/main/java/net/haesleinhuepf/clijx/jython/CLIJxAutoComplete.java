...
class CLIJxAutoComplete {
   ...
   public static ArrayList<BasicCompletion> getCompletions(final ScriptingAutoCompleteProvider provider) {
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.blur(ClearCLImageInterface source, ClearCLImageInterface destination, Float sigma_x, Float sigma_y)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.blur2D(ClearCLImageInterface source, ClearCLImageInterface destination, Float sigma_x, Float sigma_y)";
       description = "<b>blur2D</b><br><br>Computes the Gaussian blurred image of an image given two sigma values in X and Y. <br><br>Thus, the filterkernel can have non-isotropic shape.<br><br>The implementation is done separable. In case a sigma equals zero, the direction is not blurred.<br><br>DEPRECATED: This method is <b>deprecated</b>. Use gaussianBlur2D instead.<br><br>Parameters:<br>ClearCLImageInterface source, ClearCLImageInterface destination, Float sigma_x, Float sigma_y";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.blur3D(ClearCLImageInterface source, ClearCLImageInterface destination, Float sigma_x, Float sigma_y, Float sigma_z)";
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.bonejConnectedComponentsLabeling(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>bonejConnectedComponentsLabeling</b><br><br>Apply BoneJ Connected Components to an image.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.bonejSkeletonize3D(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>bonejSkeletonize3D</b><br><br>Apply BoneJ Skeletonize a binary image in 3D.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.convertToFloat(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>convertToFloat</b><br><br>Convert image to 32-bit float pixel type.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.convertToUnsignedByte(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>convertToUnsignedByte</b><br><br>Convert image to 8-bit unsigned byte pixel type.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.convertToUnsignedShort(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>convertToUnsignedShort</b><br><br>Convert image to 16-bit unsigned short pixel type.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJ2FrangiVesselness(null)";
       description = "<b>imageJ2FrangiVesselness</b><br><br>Apply ImageJ2 / ImageJ Ops Frangi Vesselness filter to an image.<br><br>Parameters:<br>null";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJ2GaussianBlur(ClearCLBuffer input, ClearCLBuffer destination, Float sigma_x, Float sigma_y, Float sigma_z)";
       description = "<b>imageJ2GaussianBlur</b><br><br>Apply ImageJ2 / ImageJ Ops Gaussian Blur to an image.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float sigma_x, Float sigma_y, Float sigma_z";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJ2MedianBox(null)";
       description = "<b>imageJ2MedianBox</b><br><br>Apply ImageJ2 / ImageJ Ops Median filter with a Sphere shape to an image.<br><br>Parameters:<br>null";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJ2MedianSphere(null)";
       description = "<b>imageJ2MedianSphere</b><br><br>Apply ImageJ2 / ImageJ Ops Median filter with a Sphere shape to an image.<br><br>Parameters:<br>null";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJ2RichardsonLucyDeconvolution(ClearCLBuffer input, ClearCLBuffer kernel_input, ClearCLBuffer destination, Integer num_iterations)";
       description = "<b>imageJ2RichardsonLucyDeconvolution</b><br><br>Apply ImageJ2 / ImageJ Ops Richardson Lucy Deconvolution to an image.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer kernel_input, ClearCLBuffer destination, Integer num_iterations";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJ2Tubeness(null)";
       description = "<b>imageJ2Tubeness</b><br><br>Apply ImageJ2 / ImageJ Ops Tubeness filter to an image.<br><br>Parameters:<br>null";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJ3DSuiteConnectedComponentsLabeling(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>imageJ3DSuiteConnectedComponentsLabeling</b><br><br>Apply ImageJ 3D Suite Connected Components Labeling (Segment 3D) to an image in 3D.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJFillHoles(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>imageJFillHoles</b><br><br>Apply ImageJs Watershed algorithm to a binary image.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJGaussianBlur(ClearCLBuffer input, ClearCLBuffer destination, Float sigma_x, Float sigma_y, Float sigma_z)";
       description = "<b>imageJGaussianBlur</b><br><br>Apply ImageJs Gaussian Blur to an image.<br><br>In case of processing a 2D image, only signa_x is used.<br><br>Note: This operation runs on the CPU.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float sigma_x, Float sigma_y, Float sigma_z";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJVariance(ClearCLBuffer input, ClearCLBuffer destination, Float sigma_x, Float sigma_y, Float sigma_z)";
       description = "<b>imageJVariance</b><br><br>Apply ImageJs Variance filter to an image.<br><br>In case of processing a 2D image, only signa_x is used.<br><br>Note: This operation runs on the CPU.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float sigma_x, Float sigma_y, Float sigma_z";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imageJWatershed(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>imageJWatershed</b><br><br>Apply ImageJs Watershed algorithm to a binary image.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.imglib2ConnectedComponentsLabeling(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>imglib2ConnectedComponentsLabeling</b><br><br>Apply imglib2 ConnectedComponents (8-connected) to an image to create a label map.<br><br>Note: This operation runs on the CPU.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.localMaximumAverageDistanceOfNClosestNeighborsMap(ClearCLBuffer input, ClearCLBuffer destination, Integer n)";
       description = "<b>localMaximumAverageDistanceOfNClosestNeighborsMap</b><br><br>Takes a label map, determines distances between all centroids, the mean distance of the n closest points for every point<br> and replaces every label with the maximum distance of touching labels.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Integer n";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.localMeanAverageDistanceOfNClosestNeighborsMap(ClearCLBuffer input, ClearCLBuffer destination, Integer n)";
       description = "<b>localMeanAverageDistanceOfNClosestNeighborsMap</b><br><br>Takes a label map, determines distances between all centroids, the mean distance of the n closest points for every point<br> and replaces every label with the mean distance of touching labels.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Integer n";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.localMedianAverageDistanceOfNClosestNeighborsMap(ClearCLBuffer input, ClearCLBuffer destination, Integer n)";
       description = "<b>localMedianAverageDistanceOfNClosestNeighborsMap</b><br><br>Takes a label map, determines distances between all centroids, the mean distance of the n closest points for every point<br> and replaces every label with the median distance of touching labels.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Integer n";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.localMinimumAverageDistanceOfNClosestNeighborsMap(ClearCLBuffer input, ClearCLBuffer destination, Integer n)";
       description = "<b>localMinimumAverageDistanceOfNClosestNeighborsMap</b><br><br>Takes a label map, determines distances between all centroids, the mean distance of the n closest points for every point<br> and replaces every label with the minimum distance of touching labels.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Integer n";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.localStandardDeviationAverageDistanceOfNClosestNeighborsMap(ClearCLBuffer input, ClearCLBuffer destination, Integer n)";
       description = "<b>localStandardDeviationAverageDistanceOfNClosestNeighborsMap</b><br><br>Takes a label map, determines distances between all centroids, the mean distance of the n closest points for every point<br> and replaces every label with the standard deviation distance of touching labels.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Integer n";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJChamferDistanceMap(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>morphoLibJChamferDistanceMap</b><br><br>Apply MorpholibJ ChamferDistanceMap to an image.<br><br>Options: <br>Weights: Svensson <3,4,5,7><br>Normalize: true<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJClassicWatershed(ClearCLBuffer gradient_input, ClearCLBuffer binary_restriction_input, ClearCLBuffer destination, Float h_min, Float h_max)";
       description = "<b>morphoLibJClassicWatershed</b><br><br>Apply MorpholibJs Classic Watershed to an image.<br><br>Connectedness: 4 (2D) / 6 (3D)<br><br>Parameters:<br>ClearCLBuffer gradient_input, ClearCLBuffer binary_restriction_input, ClearCLBuffer destination, Float h_min, Float h_max";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJExtendedMaxima(ClearCLBuffer input, ClearCLBuffer binary_destination, Float tolerance_threshold)";
       description = "<b>morphoLibJExtendedMaxima</b><br><br>Apply MorpholibJ's Extended Maxima to an image to produce an image where maxima regions are set to 255 and background to 0. <br><br>The tolerance parameter specifies how deep intensity valley between maxima can be to fuse them while maxima detection.<br>This operation uses connectivity = 6 (a.k.a. diamond).<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer binary_destination, Float tolerance_threshold";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJExtendedMinima(ClearCLBuffer input, ClearCLBuffer binary_destination, Float tolerance_threshold)";
       description = "<b>morphoLibJExtendedMinima</b><br><br>Apply MorpholibJ's Extended Minima to an image to produce an image where minima regions are set to 255 and background to 0. <br><br>The tolerance parameter specifies how deep intensity valley between minima can be to fuse them while minima detection.<br>This operation uses connectivity = 6 (a.k.a. diamond).<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer binary_destination, Float tolerance_threshold";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJFillHoles(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>morphoLibJFillHoles</b><br><br>Apply MorpholibJ Fill Holes (Binary/Gray) to an image.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJFloodFillComponentsLabeling(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>morphoLibJFloodFillComponentsLabeling</b><br><br>Apply MorpholibJ FloodFillComponentsLabeling3D to an image.<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJKeepLargestRegion(ClearCLBuffer binary_input, ClearCLBuffer binary_destination)";
       description = "<b>morphoLibJKeepLargestRegion</b><br><br>Apply MorpholibJ Keep Largest Region to a binary image.<br><br>Parameters:<br>ClearCLBuffer binary_input, ClearCLBuffer binary_destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJMarkerControlledWatershed(ClearCLBuffer gradient_input, ClearCLBuffer labelled_spots_image, ClearCLBuffer binary_restriction_input, ClearCLBuffer destination)";
       description = "<b>morphoLibJMarkerControlledWatershed</b><br><br>Apply MorpholibJs Marker-controlled Watershed to an image.<br><br>Connectedness: 4 (2D) / 6 (3D)<br><br>Parameters:<br>ClearCLBuffer gradient_input, ClearCLBuffer labelled_spots_image, ClearCLBuffer binary_restriction_input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJMorphologicalSegmentationLabelBorderImage(ClearCLBuffer input, ClearCLBuffer labels_destination, Float tolerance_threshold)";
       description = "<b>morphoLibJMorphologicalSegmentationLabelBorderImage</b><br><br>Apply MorpholibJ Morphological Segmentation to an object image to produce a label image. <br><br>The tolerance parameter specifies how deep intensity valley between local maxima can be to be ignored while flooding the regions.<br>With connectivity = 6 and using dams=false while computing the watershed.See also https://imagej.net/Morphological_Segmentation<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer labels_destination, Float tolerance_threshold";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJMorphologicalSegmentationLabelObjectImage(ClearCLBuffer input, ClearCLBuffer labels_destination, Integer gradient_radius, Float tolerance_threshold)";
       description = "<b>morphoLibJMorphologicalSegmentationLabelObjectImage</b><br><br>Apply MorpholibJ Morphological Segmentation to an object image to produce a label image. <br><br>The gradient radius parameter describes the width of edges which should be considered while separating objects.<br>The tolerance parameter specifies how deep intensity valley between local maxima can be to be ignored while flooding the regions.<br>With connectivity = 6 and using dams=false while computing the watershed.<br>See also https://imagej.net/Morphological_Segmentation<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer labels_destination, Integer gradient_radius, Float tolerance_threshold";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.morphoLibJRemoveLargestRegion(ClearCLBuffer labels_input, ClearCLBuffer labels_destination, Boolean left, Boolean right, Boolean top, Boolean bottom, Boolean front, Boolean back)";
       description = "<b>morphoLibJRemoveLargestRegion</b><br><br>Apply MorpholibJ Remove Border Labels to a label image.<br><br><br><br>Parameters:<br>ClearCLBuffer labels_input, ClearCLBuffer labels_destination, Boolean left, Boolean right, Boolean top, Boolean bottom, Boolean front, Boolean back";
       list.add(new BasicCompletion(provider, headline, null, description));
       ...
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKBilateral(ClearCLBuffer input, ClearCLBuffer destination, Float domainSigma, Float rangeSigma, Float numberOfRangeGaussianSamples)";
       description = "<b>simpleITKBilateral</b><br><br>Apply SimpleITKs Bilateral filter to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1BilateralImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float domainSigma, Float rangeSigma, Float numberOfRangeGaussianSamples";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKBinaryFillhole(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>simpleITKBinaryFillhole</b><br><br>Apply SimpleITKs Binary Fill hole to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1BinaryFillholeImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKBinaryPruning(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>simpleITKBinaryPruning</b><br><br>Apply SimpleITKs Binary Pruning to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1BinaryPruningImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKBinaryThinning(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>simpleITKBinaryThinning</b><br><br>Apply SimpleITKs Binary Thinning to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1BinaryThinningImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKBinomialBlur(ClearCLBuffer input, ClearCLBuffer destination, Float repetitions)";
       description = "<b>simpleITKBinomialBlur</b><br><br>Apply SimpleITKs Binomial Blur filter to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1BinomialBlurImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float repetitions";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKBoundedReciprocal(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>simpleITKBoundedReciprocal</b><br><br>Apply SimpleITKs BoundedReciprocal to an image.<br><br>Computes 1/(1+x) for each pixel<br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1BoundedReciprocalImageFilter.html#details<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKCannyEdgeDetection(ClearCLBuffer arg1, ClearCLBuffer arg2, Float arg3, Float arg4, Float arg5, Float arg6)";
       description = "<b>simpleITKCannyEdgeDetection</b><br><br>Apply SimpleITKs Canny edge detection filter to an image.<br><br>https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1CannyEdgeDetectionImageFilter.html<br><br>Parameters:<br>ClearCLBuffer arg1, ClearCLBuffer arg2, Float arg3, Float arg4, Float arg5, Float arg6";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKConnectedComponent(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>simpleITKConnectedComponent</b><br><br>Apply SimpleITKs ConnectedComponent to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1ConnectedComponentImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKDanielssonDistanceMap(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>simpleITKDanielssonDistanceMap</b><br><br>Generate SimpleITKs Danielsson distance map from a binary image.<br><br>Compared to SimpleITK, the image is binary inverted before the map is generated to make the operation similar to ImageJs implementation.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1DanielssonDistanceMapImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKDiscreteGaussian(ClearCLBuffer input, ClearCLBuffer destination, Float sigma_x, Float sigma_y, Float sigma_z)";
       description = "<b>simpleITKDiscreteGaussian</b><br><br>Apply SimpleITKs Gaussian Blur to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1DiscreteGaussianImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float sigma_x, Float sigma_y, Float sigma_z";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKFFTConvolution(ClearCLBuffer input, ClearCLBuffer input_kernel, ClearCLBuffer destination)";
       description = "<b>simpleITKFFTConvolution</b><br><br>Convolve an image with a kernel image using SimpleITK and a fast Fourier transform (FFT).<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1FFTConvolutionImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer input_kernel, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKHMaxima(ClearCLBuffer input, ClearCLBuffer destination, Float h)";
       description = "<b>simpleITKHMaxima</b><br><br>Apply SimpleITKs H-Maxima filter to an image.<br><br>Suppress local maxima whose height above the baseline is less than h.See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1HMaximaImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float h";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKInverseDeconvolution(ClearCLBuffer input, ClearCLBuffer input_psf, ClearCLBuffer destination, Float kernelZeroMagnitudeThreshold, Boolean normalize)";
       description = "<b>simpleITKInverseDeconvolution</b><br><br>Apply SimpleITKs Inverse Deconvolution to an image.<br><br>See also: https://itk.org/Doxygen/html/classitk_1_1InverseDeconvolutionImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer input_psf, ClearCLBuffer destination, Float kernelZeroMagnitudeThreshold, Boolean normalize";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKLandweberDeconvolution(ClearCLBuffer input, ClearCLBuffer input_psf, ClearCLBuffer destination, Float alpha)";
       description = "<b>simpleITKLandweberDeconvolution</b><br><br>Apply SimpleITKs Landweber Deconvolution to an image.<br><br>See also: https://itk.org/Doxygen/html/classitk_1_1LandweberDeconvolutionImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer input_psf, ClearCLBuffer destination, Float alpha";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKMedian(ClearCLBuffer input, ClearCLBuffer destination, Float radius_x, Float radius_y, Float radius_z)";
       description = "<b>simpleITKMedian</b><br><br>Apply SimpleITKs Median filter to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1MedianImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float radius_x, Float radius_y, Float radius_z";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKMedianProjection(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>simpleITKMedianProjection</b><br><br>Apply SimpleITKs Median projection to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1MedianProjectionImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKMorphologicalWatershed(ClearCLBuffer input, ClearCLBuffer destination, Float level)";
       description = "<b>simpleITKMorphologicalWatershed</b><br><br>Apply SimpleITKs Morphological Watershed filter to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1MorphologicalWatershedImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float level";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKOtsuMultipleThresholds(ClearCLBuffer input, ClearCLBuffer destination, Float number_of_thresholds)";
       description = "<b>simpleITKOtsuMultipleThresholds</b><br><br>Apply SimpleITKs Otsu Multiple Thresholds to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1OtsuMultipleThresholdsImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float number_of_thresholds";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKOtsuThreshold(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>simpleITKOtsuThreshold</b><br><br>Apply SimpleITKs Otsu Thresholding to an image.<br><br>Compared to SimpleITKs implementation, results are inverted to match ImageJs behaviour.<br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1OtsuThresholdImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKTikhonovDeconvolution(ClearCLBuffer input, ClearCLBuffer input_psf, ClearCLBuffer destination, Float regularisation_constant, Boolean normalize)";
       description = "<b>simpleITKTikhonovDeconvolution</b><br><br>Apply SimpleITKs Tikhonov Deconvolution to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1TikhonovDeconvolutionImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer input_psf, ClearCLBuffer destination, Float regularisation_constant, Boolean normalize";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKWienerDeconvolution(ClearCLBuffer input, ClearCLBuffer input_psf, ClearCLBuffer destination, Float noise_variance, Boolean normalize)";
       description = "<b>simpleITKWienerDeconvolution</b><br><br>Apply SimpleITKs Wiener Deconvolution to an image.<br><br>See also: https://itk.org/Doxygen/html/classitk_1_1WienerDeconvolutionImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer input_psf, ClearCLBuffer destination, Float noise_variance, Boolean normalize";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKZeroCrossing(ClearCLBuffer input, ClearCLBuffer destination)";
       description = "<b>simpleITKZeroCrossing</b><br><br>Apply SimpleITKs ZeroCrossing to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1ZeroCrossingImageFilter.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleITKZeroCrossingBasedEdgeDetection(ClearCLBuffer input, ClearCLBuffer destination, Float variance, Float maximum_error)";
       description = "<b>simpleITKZeroCrossingBasedEdgeDetection</b><br><br>Apply SimpleITKs ZeroCrossingBasedEdgeDetection to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/sitkZeroCrossingBasedEdgeDetectionImageFilter_8h.html<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer destination, Float variance, Float maximum_error";
       list.add(new BasicCompletion(provider, headline, null, description));
       headline = "clijx.simpleItkRichardsonLucyDeconvolution(ClearCLBuffer input, ClearCLBuffer input_psf, ClearCLBuffer destination, Float num_iterations, Boolean normalize)";
       description = "<b>simpleItkRichardsonLucyDeconvolution</b><br><br>Apply SimpleITKs Richardson-Lucy Deconvolution to an image.<br><br>See also: https://simpleitk.org/doxygen/latest/html/classitk_1_1simple_1_1RichardsonLucyDeconvolutionImageFilter.htmll<br><br>Parameters:<br>ClearCLBuffer input, ClearCLBuffer input_psf, ClearCLBuffer destination, Float num_iterations, Boolean normalize";
       list.add(new BasicCompletion(provider, headline, null, description));
