...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_concatenateStacks")
public class ConcatenateStacks extends net.haesleinhuepf.clij2.plugins.ConcatenateStacks {
}
