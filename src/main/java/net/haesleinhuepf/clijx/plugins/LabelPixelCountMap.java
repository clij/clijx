...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_labelPixelCountMap")
public class LabelPixelCountMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized {
