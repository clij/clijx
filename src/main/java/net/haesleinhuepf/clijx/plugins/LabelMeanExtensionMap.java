...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_labelMeanExtensionMap")
public class LabelMeanExtensionMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
