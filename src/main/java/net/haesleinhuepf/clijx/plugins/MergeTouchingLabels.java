 ...
 *         July 2020
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_mergeTouchingLabels")
public class MergeTouchingLabels extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized {
