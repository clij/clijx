...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_labelMaximumExtensionMap")
public class LabelMaximumExtensionMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
