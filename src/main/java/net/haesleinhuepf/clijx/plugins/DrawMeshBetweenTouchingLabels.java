...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_drawMeshBetweenTouchingLabels")
public class DrawMeshBetweenTouchingLabels extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized {
