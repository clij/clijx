...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_divideByGaussianBackground")
public class DivideByGaussianBackground extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized {
    @Override
