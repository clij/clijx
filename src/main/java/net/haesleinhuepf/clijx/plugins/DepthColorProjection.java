 ...
 *         April 2020
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_depthColorProjection")
public class DepthColorProjection extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
    ...
    public boolean executeCL() {
        boolean result = depthColorProjection(getCLIJ2(), (ClearCLBuffer)( args[0]), (ClearCLBuffer)(args[1]), (ClearCLBuffer)(args[2]), asFloat(args[2]), asFloat(args[3]));
        return result;
    }
