...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_maximumNeighborDistanceMap")
public class MaximumNeighborDistanceMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
