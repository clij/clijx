...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_labelMiniumIntensityMap")
public class LabelMinimumIntensityMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public static boolean labelMinimumIntensityMap(CLIJ2 clij2, ClearCLBuffer input, ClearCLBuffer label_map, ClearCLBuffer result) {
