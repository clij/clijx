 ...
 * July 2020
 */
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_zPositionRangeProjection")
public class ZPositionRangeProjection extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    ...
    public static boolean zPositionRangeProjection(CLIJ2 clij2, ClearCLImageInterface src, ClearCLImageInterface position, ClearCLImageInterface dst, int relative_start_z, int relative_end_z) {
        ...
        for (int z = relative_start_z; z <= relative_end_z; z++) {
            ...
            clij2.copySlice(temp_slice, dst, z - relative_start_z);
        }
        return true;
    }
    ...
    public String getParameterHelpText() {
        return "Image source_stack, Image z_position, ByRef Image destination, Number relative_start_z, Number relative_end_z";
    }
