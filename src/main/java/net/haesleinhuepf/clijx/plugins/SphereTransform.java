...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJx_sphereTransform")
public class SphereTransform extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized {
