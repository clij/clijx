...
public class LabelMeanOfLaplacianMap extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    ...
    public boolean executeCL() {
        return labelMeanOfLaplacianMap(getCLIJ2(), (ClearCLBuffer) args[0], (ClearCLBuffer) args[1], (ClearCLBuffer) args[2]);
    }

    public static boolean labelMeanOfLaplacianMap(CLIJ2 clij2, ClearCLBuffer input, ClearCLBuffer label_map, ClearCLBuffer result) {
        ...
        clij2.statisticsOfBackgroundAndLabelledPixels(laplacian, label_map, table);
        laplacian.close();
