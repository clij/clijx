...
public class ReduceLabelsToLabelledSpots extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation, IsCategorized, HasClassifiedInputOutput {
    @Override
    ...
    public boolean executeCL() {
        return reduceLabelsToLabelledSpots(getCLIJ2(), (ClearCLBuffer) args[0], (ClearCLBuffer) args[1]);
    }
